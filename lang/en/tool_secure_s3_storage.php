...
$string['configurationstatus'] = 'Effective configuration';
...
$string['editschedules'] = 'Edit schedules in Moodle scheduled tasks';
$string['enabledlabel'] = 'Enabled';
$string['errorlabel'] = 'Error category';
$string['faildelaylabel'] = 'Failure delay (seconds)';
$string['filenamelabel'] = 'Artifact or content hash';
$string['invalidmanualtask'] = 'The requested manual transfer type is invalid.';
$string['lastrunlabel'] = 'Last run';
$string['manualtaskalreadyqueued'] = 'An identical transfer is already queued.';
$string['manualtaskdisabled'] = 'Enable this transfer type before requesting a manual run.';
$string['manualtaskdisabledshort'] = 'Disabled';
$string['manualtaskqueued'] = 'The transfer was queued for Moodle Cron.';
$string['manualtaskstarted'] = 'Starting administrator-requested {$a} transfer.';
$string['nextrunlabel'] = 'Next run';
$string['openoperationsstatus'] = 'Open operational status and manual actions';
$string['operations'] = 'Operations';
$string['operations_desc'] = 'Review schedules, transfer history, retention ownership, and queue a background transfer without running backup work in the web request.';
$string['operationssecuritynotice'] = 'Manual actions are queued for Moodle Cron and still require the corresponding transfer setting to be enabled. This page does not restore data or delete local or S3 objects.';
$string['operationsstatus'] = 'Secure S3 Storage operational status';
...
$string['queuenow'] = 'Queue now';
$string['recenttransfers'] = 'Recent transfer audit records';
$string['region'] = 'AWS region';
$string['region_desc'] = 'AWS region containing the destination bucket.';
$string['retention_content'] = 'Moodle filedir content: never deleted by this plugin.';
$string['retention_course'] = 'Local course archives: controlled by Moodle automated-backup retention settings.';
$string['retention_database'] = 'Local database artifacts: preserved by this plugin; remove only through a separately tested operator procedure.';
$string['retention_s3'] = 'S3 objects: use bucket Versioning and Lifecycle rules scoped to the dedicated prefix; this plugin does not delete remote objects.';
$string['retentionpolicy'] = 'Retention and deletion ownership';
$string['retentionpolicy_desc'] = 'Deletion is intentionally separated from transfer. A successful upload does not by itself authorize deletion.';
$string['scheduledoperations'] = 'Scheduled and manual transfers';
$string['schedulelabel'] = 'Cron expression';
...
$string['transferstatus_observed'] = 'Observed';
$string['transferstatus_success'] = 'Verified';
$string['transferstatus_uploading'] = 'Uploading';
$string['transfersummary'] = 'Transfer audit summary';
$string['updatedlabel'] = 'Last updated';
