...
$string['privacy:metadata'] = 'Secure S3 Storageは、成果物のファイル名、サイズ、チェックサム、オブジェクトキー、転送状態、時刻を記録します。コースアーカイブとDBバックアップ成果物には個人データが含まれる場合があり、設定したS3転送先へ送信されます。';
$string['privacy:metadata:s3'] = '設定されたS3互換ストレージへ、有効にした種類のMoodleバックアップ成果物を送信します。';
$string['privacy:metadata:s3:archive'] = 'Moodleのユーザーおよびサイトデータを含む可能性があるコースアーカイブまたはDBバックアップ成果物です。';
